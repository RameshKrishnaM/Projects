...
func Panfulldetails(pPayload string, pDebug *helpers.HelperStruct, req *http.Request) (string, error) {
	...
	lPass_url := tomlconfig.GtomlConfigLoader.GetValueString("kra", "pass_url")
	lPANDetailsFetchALLKRA := tomlconfig.GtomlConfigLoader.GetValueString("kra", "PANDetailsFetchALLKRA")
