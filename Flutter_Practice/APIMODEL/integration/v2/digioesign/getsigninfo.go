...
func GetSignInfo(pDebug *helpers.HelperStruct, DocID string) (string, error) {
	pDebug.Log(helpers.Statement, "GetSignInfo (+)")
	...
	lResp, lErr := apiUtil.Api_call(pDebug, lUrl, "GET", "", lHeaderArr, "digio.GetSignInfo")
