...
class _PersInfoScreenState extends State<PersInfoScreen> {
  ...
  void initState() {
    /* 
  Purpose: This will wait for the ui renders after that the fetchMaritalDropDownDetails will execute
  */
  ...
  /* 
  Purpose: This method is used to get regular expression for the facta form
  */
  ...
  /* 
  Purpose: This method is used to validate all hte form entered in the screen
  */
            ...
            children: [
              Column(
                ...
                children: [
                  ...
                  SizedBox(
                    height: isShowMothersField ? 30.0 : 15.0,
                  ),
                  Row(
                    mainAxisAlignment: MainAxisAlignment.center,
                    children: [
                      ...
                      child: Column(
                          ...
                          children: [
                            ...
                            ...customFormField(
                                ...
                                validator: (value) => validateName(value,
                                    "Education Qualification Others", 4)),
                          ])),
                  const SizedBox(
                    height: 30.0,
                  ),
  ...
  insertPersInfo() async {
    ...
    Map addPersonalDetailsJson = {
      ...
      "mothertitle": momNameTitleController.text.isNotEmpty
          ? nameTitleDropDownData.firstWhere((element) =>
